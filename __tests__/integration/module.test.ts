...
describe('Module routes', () => {
  ...
  describe('PATCH /api/v1/modules/:moduleId', () => {
    ...
    test('should return 200 and successfully update hivemind module if platform is discord', async () => {
      await insertCommunities([communityOne, communityTwo, communityThree]);
      await insertUsers([userOne, userTwo]);
      await insertModules([moduleOne, moduleTwo]);
    ...
    test('should return 200 and successfully update hivemind module if platform is google', async () => {
      await insertCommunities([communityOne, communityTwo, communityThree]);
      await insertUsers([userOne, userTwo]);
      await insertModules([moduleOne, moduleTwo]);
    ...
    test('should return 200 and successfully update hivemind module if platform is github', async () => {
      await insertCommunities([communityOne, communityTwo, communityThree]);
      await insertUsers([userOne, userTwo]);
      await insertModules([moduleOne, moduleTwo]);
  ...
  describe('DELETE /api/v1/modules/:moduleId', () => {
    ...
    test('should return 401 error if access token is missing', async () => {
      ...
      await insertUsers([userOne, userTwo]);
      await insertModules([moduleOne, moduleTwo]);
      await request(app).delete(`/api/v1/modules/${moduleOne._id}`).send().expect(httpStatus.UNAUTHORIZED);
    });
