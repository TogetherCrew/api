  ...
  describe('POST /api/v1/member-activity/:guildId/active-members-composition-line-graph', () => {
    ...
    test('should return 200 and active members composition line graph data if req data is ok', async () => {
      ...
      await insertMemberActivities(
        [memberActivityOne, memberActivityTwo, memberActivityThree, memberActivityFour],
        connection,
      );
        ...
        expect.arrayContaining([
          {
            from: {
              ...
              id: '123456789',
              discordId: '123456789',
              joinedAt: '2023-03-07T00:00:00.000Z',
              ngu: 'Behzad',
              radius: 3,
              roles: [],
              stats: 'SENDER',
            ...
            to: {
              ...
              id: '987654321',
              discordId: '987654321',
              joinedAt: '2023-03-31T00:00:00.000Z',
              ngu: 'Daniel',
              radius: 3,
              roles: [],
              stats: 'RECEIVER',
  ...
  describe('GET /api/v1/member-activity/:guildId/active-members-composition-table', () => {
    ...
    test('should return 200 and apply the default query options', async () => {
      ...
      await insertGuildMembers(
        [guildMemberOne, guildMemberTwo, guildMemberThree, guildMemberFour, guildMemberFive],
        connection,
      );
      await insertRoles([role1, role2, role3], connection);
      const res = await request(app)
      ...
      expect(res.body.results[0]).toEqual({
        ...
        roles: [{ roleId: role2.roleId, name: role2.name, color: role2.color }],
      ...
      expect(res.body.results[3]).toEqual({
        ...
        roles: [{ roleId: role1.roleId, name: role1.name, color: role1.color }],
