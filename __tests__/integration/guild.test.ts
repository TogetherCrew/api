...
describe('Guild routes', () => {
  ...
  describe('GET /api/v1/guilds/:guildId/channels', () => {
    ...
    test('should return 401 if access token is missing', async () => {
      await insertUsers([userOne]);
      await request(app).get(`/api/v1/guilds/${guildFive.guildId}/channels`).send().expect(httpStatus.UNAUTHORIZED);
    });
  });
  ...
  describe('GET /api/v1/guilds/:guildId', () => {
    ...
    test('should return 401 if access token is missing', async () => {
      ...
      await request(app).get(`/api/v1/guilds/${guildOne.guildId}`).expect(httpStatus.UNAUTHORIZED);
    });
    test('should return 440 if did not find guild with guildId and relative user', async () => {
      await insertUsers([userOne]);
      await request(app)
  ...
  describe('GET /api/v1/guilds/connect/callback', () => {
    ...
    test('should return 302 and successfully create guild', async () => {
      await insertUsers([userOne]);
      await request(app).get('/api/v1/guilds/connect/callback').query({ code: 'code' }).send().expect(httpStatus.FOUND);
    ...
    test('should return 302 if code does not provided', async () => {
      await request(app).get('/api/v1/guilds/connect/callback').send().expect(httpStatus.FOUND);
    });
  });
  ...
  describe('PATCH /api/v1/guilds/:guildId', () => {
    ...
    test('should return 401 if access token is missing', async () => {
      ...
      await request(app).patch(`/api/v1/guilds/${guildOne.guildId}`).send(updateBody).expect(httpStatus.UNAUTHORIZED);
    });
  ...
  describe('GET /api/v1/guilds/discord-api/:guildId', () => {
    ...
    test('should return 401 if access token is missing', async () => {
      ...
      await request(app).get(`/api/v1/guilds/discord-api/${guildOne.guildId}`).expect(httpStatus.UNAUTHORIZED);
    });
  ...
  describe('GET /api/v1/guilds', () => {
    ...
    test('should return 401 if access token is missing', async () => {
      ...
      await request(app).get('/api/v1/guilds').send().expect(httpStatus.UNAUTHORIZED);
    });
  ...
  describe('GET /api/v1/guilds/:guildId/roles', () => {
    ...
    test('should return 401 if access token is missing', async () => {
      await insertUsers([userOne]);
      await request(app).get(`/api/v1/guilds/${guildFive.guildId}/roles`).expect(httpStatus.UNAUTHORIZED);
    });
    test('should return 400 if guild id is not valid', async () => {
      await insertUsers([userOne]);
      await request(app).get(`/api/v1/guilds/1234/roles`).expect(httpStatus.UNAUTHORIZED);
    });
