...
router.get('/:guildId/member-interactions-graph', validate(memberActivityValidation.memberInteractionsGraph), memberActivityController.memberInteractionsGraph)
