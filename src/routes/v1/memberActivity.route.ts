...
// Routes
router.post(
  '/:guildId/active-members-composition-line-graph',
  auth(),
...
router.post(
  '/:guildId/active-members-onboarding-line-graph',
  auth(),
...
router.post(
  '/:guildId/disengaged-members-composition-line-graph',
  auth(),
