...
router.get('/:guildId/decentralisation-score', auth(), validate(memberActivityValidation.decentralisationScore), memberActivityController.activeMembersCompositionTable);
