...
router.get('/:guildId/member-interactions-graph', auth(), validate(memberActivityValidation.memberInteractionsGraph), memberActivityController.memberInteractionsGraph)
